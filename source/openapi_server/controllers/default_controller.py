...
def get_time_series_for_collection_id(collection_id, bbox, timespan):  # noqa: E501
    ...
    :type bbox: str
    :param timespan: start and end time
    :type timespan: str

    :rtype: List[float]
    """
    return util.get_time_series_for_collection_id(collection_id, bbox, timespan)
